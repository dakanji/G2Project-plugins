...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="Missing Keywords"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items are missing keyword entries:"}
    ...
    {else}
	{g->text text="There are no items that have missing keyword entries."}
    {/if}	
