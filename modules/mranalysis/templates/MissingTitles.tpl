...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="Missing Titles"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items are missing titles or have default camera generated titles:"}
    ...
    {else}
	{g->text text="There are no items that have missing titles or have default camera generated titles."}
    {/if}	
