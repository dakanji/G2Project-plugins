{*
 * $RCSfile: DefaultFileNames.tpl,v $
 * $Revision: 1824 $
...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="Default Filenames"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items have default (Camera generated) filenames:"}
    ...
    {else}
	{g->text text="There are no items that have default (Camera generated) entries."}
    {/if}	
