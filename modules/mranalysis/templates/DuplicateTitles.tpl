...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="Duplicate Titles"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items have duplicate titles:"}
    ...
    {else}
	{g->text text="There are no items that have duplicate titles."}
    {/if}	
