{*
 * $RCSfile: ExtensionsInTitles.tpl,v $
 * $Revision: 1824 $
...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="File Extensions in Titles"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items have file extensions in their titles:"}
    ...
    {else}
	{g->text text="There are no items that have file extensions in their titles."}
    {/if}	
