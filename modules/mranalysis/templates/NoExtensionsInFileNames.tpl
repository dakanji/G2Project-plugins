{*
 * $RCSfile: NoExtensionsInFileNames.tpl,v $
 * $Revision: 1824 $
...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="No File Extensions in FileNames"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items have no file extensions in their filenames:"}
    ...
    {else}
	{g->text text="There are no items that have no file extensions in their filenames."}
    {/if}	
