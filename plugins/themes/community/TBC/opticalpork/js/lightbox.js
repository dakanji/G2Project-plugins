...
//	Configuration
//
var fileLoadingImage        = "http://opticalpork.com/themes/opticalpork/images/loading.gif";
var fileBottomNavCloseImage = "http://opticalpork.com/themes/opticalpork/images/closelabel.gif";
...
Lightbox.prototype = {
	...
	start: function (imageLink) {
		...
		if ((imageLink.getAttribute('rel') == 'lightbox')) {
			...
			imageArray.push(new Array(imageLink.getAttribute('href'), imageLink.getAttribute('capt')));
		} else {
			...
			for (var i = 0; i < anchors.length; i++) {
				...
				if (anchor.getAttribute('href') && (anchor.getAttribute('rel') == imageLink.getAttribute('rel'))) {
					imageArray.push(new Array(anchor.getAttribute('href'), anchor.getAttribute('capt')));
				}
			}
