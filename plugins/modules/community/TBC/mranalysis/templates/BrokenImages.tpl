...
<div class="gbBlock gcBackground1">
  <h2 class="gbTitle"> {g->text text="Broken Images"} </h2>
</div>
...
<br>
    ...
    {if count($baditems) > 0}
	{g->text text="The following items have broken derivatives:"}
    ...
    {else}
	{g->text text="There are no items that have broken derivatives."}
    {/if}	
    </div>
  </div>
