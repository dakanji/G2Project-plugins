## mysql
# mapMap
CREATE TABLE DB_TABLE_PREFIXmapMap(
...
CREATE INDEX DB_TABLE_PREFIXmapMap_75985 ON DB_TABLE_PREFIXmapMap(DB_COLUMN_PREFIXitemId);
...
CREATE INDEX DB_TABLE_PREFIXmapMap_75985
   ON DB_TABLE_PREFIXmapMap(DB_COLUMN_PREFIXitemId);
