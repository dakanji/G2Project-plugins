...
{* List Comments Block *}
<a href="{g->url arg1="view=comment.AddComment" arg2="itemId=`$theme.item.id`"}">Add comment</a>

<a href="#" onclick="Effect.toggle('optical-comments','blind'); return false">View Comments</a>
<div id="optical-comments" style="display: none;height:200px;width:300px;background-color:#ddd"><div>
  {g->block type="comment.ViewComments" params="itemId=`$theme.item.id`"}
</div></div>
