...
*}
    ...
    <input type="text" id="subject{$item.id}" size="60" class="gcBackground1"
...
*}
    ...
    <textarea rows="15" cols="60" id="comment{$item.id}" class="gcBackground1"
